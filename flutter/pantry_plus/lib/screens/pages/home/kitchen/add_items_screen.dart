                                    ...
                                    children: [
                                      ...
                                      if (controller.newItem.value.itemImage !=
                                        ...
                                        ClipRRect(
                                          ...
                                          child: Image.file(
                                            File(controller.storedImg.value),
                                            fit: BoxFit.cover,
                              ...
                              TextFormField(
                                onSaved: (newValue) {
                                  controller.newItem.update((val) {
                                    ...
                                    val!.itemKeywords = newValue!.split(",");
                                  });
                                  controller.update();
                                },
                                maxLines: 2,
                                ...
                                decoration: const InputDecoration(
                                    border: OutlineInputBorder(),
                                    hintText:
                                        "Enter Keywords related to ingredient separated by commas",
                                    labelText: "Keywords",
                                    alignLabelWithHint: true),
                              ),
